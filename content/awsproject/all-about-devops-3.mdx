...
<img src="https://i.ibb.co/YXzrbMN/build-source-config.png" />

-   Config the environment

<img src="https://i.ibb.co/hW5VnhD/build-env-config.png" />
...
<img src="https://i.ibb.co/mb2FPnv/build-artifacts-config.png" />
...
<img src="https://i.ibb.co/YQ9LfkZ/build-cloudwatch-log.png" />
...
<img src="https://i.ibb.co/JqHFNyq/build-service-role.png" />
...
<img src="https://i.ibb.co/cNxcZmM/buildspec-code.png" />

#### 4. Start the build

<img src="https://i.ibb.co/qd6V6zp/build-success.png" />

#### 5. Check the S3 bucket

The .zip file that contains the WAR file appears in the bucket. The build is done 🎉

<img src="https://i.ibb.co/SsXXzb5/zip-file-in-s3.png" />
