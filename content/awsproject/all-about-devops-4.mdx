...
date: 2024-06-20
cover: https://i.ibb.co/fH4NN5d/Screenshot-2024-06-19-at-3-18-54-PM.png
...
<img src="https://i.ibb.co/7kMH5dL/deploy-flow.png" />
...
<img src="https://i.ibb.co/HHjNsJX/stack-details.png" />
...
<img src="https://i.ibb.co/QMSXcDc/server-instance.png" />
...
<img src="https://i.ibb.co/PrGx3Q4/scripts-folder.png" className="small-img" />

#### 3. Create a appspec.yml file

-   Create a appspec.yml file in the root of the code repository

<img src="https://i.ibb.co/JrRpBfm/appspec-code.png" />
...
<img src="https://i.ibb.co/r6c77GV/update-buildspec.png" />
...
<img src="https://i.ibb.co/8mHCVF0/deploy-role.png" />

#### 5. Create a CodeDeploy application and deployment group

<img src="https://i.ibb.co/nB3yqM4/set-up-deploy.png" />

<img src="https://i.ibb.co/kyv2Trv/create-deployment-group.png" />

#### 6. Create and launch a deployment

In the config, I pointed CodeDeploy to WAR file's S3 bucket.

<img src="https://i.ibb.co/W2nVMGx/deployment-setting.png" />

Config the environment to the EC2 instance.

<img src="https://i.ibb.co/jyLJXsS/deploy-env-config.png" />

After configuration, I lauched the deployment, and oops it fails....

<img src="https://i.ibb.co/wBLRDTQ/deploy-failed.png" />
...
<img src="https://i.ibb.co/LxpbDqd/codedeploy-agent-active.png" />
...
<img src="https://i.ibb.co/17mKGdL/doc-view-log-file.png" />

By following the Amazon doc instruction, I logged the deployment process and find the error:

<img src="https://i.ibb.co/616xZKV/log-error.png" />
...
<img src="https://i.ibb.co/DVyjZsJ/appspec-empty.png" />

I pushed the appspec.yml file again and made another deployment....and it failed again...🤦‍♀️

<img src="https://i.ibb.co/61JBtPB/failed-warning.png" />

<img src="https://i.ibb.co/4K0QVBm/log-error2.png" />
...
<img src="https://i.ibb.co/kqGstkC/deploy-success.png" />

### Delployment succeed!

The web page is live 🎉

<img src="https://i.ibb.co/FbQYpSb/host-live.png" />
